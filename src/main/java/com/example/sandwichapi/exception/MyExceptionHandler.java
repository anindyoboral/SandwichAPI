...
public class MyExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<? extends Object> handlePersonAlreadyExists(SandwichAlreadyExistsException pnfe,
                                                                         WebRequest request) {
    ...
    @ExceptionHandler(value = SandwichCanNotBeDeletedException.class)
    protected ResponseEntity<? extends Object> handlePersonCannotBeDeleted(SandwichCanNotBeDeletedException pcde,
                                                                           WebRequest request) {
        HttpStatus status = HttpStatus.CONFLICT;
